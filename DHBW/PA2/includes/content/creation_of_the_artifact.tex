...
The following table shows the weighting of the criteria that was used to evaluate the tools:

\begin{table}[htb]
    \centering
    \begin{tabular}{|l|l|} \hline
        \textbf{Criteria}                       & \textbf{Weight}       \\ \hline
        Ease of use                             & TBD                   \\ \hline
        Extensibility                           & TBD                   \\ \hline
        Community, Support and  Documentation   & TBD                   \\ \hline
        Maturity                                & TBD                   \\ \hline
        Strategic alignment with \ac{HPE}       & TBD                   \\ \hline
        License                                 & TBD                   \\ \hline
        Cost                                    & TBD                   \\ \hline
...
!TODO!
Justify the weighting of the criteria
....
