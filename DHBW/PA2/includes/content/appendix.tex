...
\anhangteil{Lookup table weigting funcitons}
...
\begin{figure}[htb]
  ...
  \caption[Swimlane Diagram of the communication between the user and Pachyderm]{Swimlane Diagram of the communication between the user and Pachyderm\footnotemark}
