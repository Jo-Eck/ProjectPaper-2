...
% \newpage
% \anhangteil{Docker Registry Deployment}
% \label{appendix:docker_registry_config}
% \lstinputlisting{../../Project/Kubernetes_Setup/registry/registry.yaml}

% \newpage
% \anhangteil{Frogejo Deployment}
% \label {appendix:frogejo_config}
% \lstinputlisting{../../Project/Kubernetes_Setup/ci_cd/forgejo/values.yaml}
% \lstinputlisting{../../Project/Kubernetes_Setup/ci_cd/forgejo/config_map_ini.yaml}

% \newpage
% \anhangteil{Jenkins Dockerfile}
% \label{appendix:jenkins_dockerfile}
% \lstinputlisting{../../Project/Kubernetes_Setup/ci_cd/jenkins/custom_jenkins_container/custom_jenkins.dockerfile}